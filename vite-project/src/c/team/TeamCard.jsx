...
<div className=" px-4 w-full min-[540px]:w-2/4  min-[960px]:w-1/4">
                  <div className=" max-w-[12.50rem] mx-auto mb-10">
                    ...
                    <div className="text-center">
                      <h5 className="dark:text-whit text-gray-900 font-semibold mb-1">
                        {props.name}
                      </h5>

                      <p className="dark:text-whit text-gray-500 text-[0.63rem] uppercase mb-4">
                       {props.job}
                      </p>

                      <div className="items-center justify-center flex gap-5 text-gray-200">
                        <a href="#">
                          <svg
